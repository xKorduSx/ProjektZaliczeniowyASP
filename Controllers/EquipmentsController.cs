...
namespace SportsEquipmentRental.Controllers
{
    public class EquipmentsController : Controller
    {
		...
		[Authorize(Roles = "Admin")]
		public async Task<IActionResult> Create([Bind("EquipmentId,Name,Category,IsAvailable,RentalPricePerDay")] Equipment equipment)
        {
        ...
        [ValidateAntiForgeryToken]
		[Authorize(Roles = "Admin")]
		public async Task<IActionResult> Edit(int id, [Bind("EquipmentId,Name,Category,IsAvailable,RentalPricePerDay")] Equipment equipment)
        {
